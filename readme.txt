...
### Liked admin-bar Plugins?
Rate us on [WordPress Forum](https://wordpress.org/support/plugin/admin-bar/reviews/#new-post) 🙂


== Source Code ==
[Source Code](https://github.com/litonarefin/admin-bar)
...
If you like our admin-bar plugin then why not check some other plugins that developed by us:
